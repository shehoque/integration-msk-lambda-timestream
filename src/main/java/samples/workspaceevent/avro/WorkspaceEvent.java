...
public class WorkspaceEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CharSequence workspaceId;
  @Deprecated public long eventTimestamp;
  @Deprecated public CharSequence modelId;
   ...
   */
  public WorkspaceEvent(CharSequence workspaceId, Long eventTimestamp, CharSequence modelId, CharSequence state, CharSequence version, Double memUtil, Double cpuUtl) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: workspaceId = (CharSequence)value$; break;
    case 1: eventTimestamp = (Long)value$; break;
    case 2: modelId = (CharSequence)value$; break;
    case 3: state = (CharSequence)value$; break;
    case 4: version = (CharSequence)value$; break;
    case 5: memUtil = (Double)value$; break;
    case 6: cpuUtl = (Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public CharSequence getWorkspaceId() {
    return workspaceId;
  }
   ...
   */
  public void setWorkspaceId(CharSequence value) {
   ...
   */
  public CharSequence getModelId() {
    return modelId;
  }
   ...
   * @param value the value to set.
   */
  public void setModelId(CharSequence value) {
    this.modelId = value;
  }
   ...
   * @param value the value to set.
   */
  public void setCpuUtl(Double value) {
    this.cpuUtl = value;
  }
  ...
  public static Builder newBuilder(WorkspaceEvent other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WorkspaceEvent>
    ...
    private CharSequence workspaceId;
    private long eventTimestamp;
    private CharSequence modelId;
    ...
    private Builder(WorkspaceEvent other) {
            super(WorkspaceEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.workspaceId)) {
        this.workspaceId = data().deepCopy(fields()[0].schema(), other.workspaceId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'workspaceId' field */
    public Builder setWorkspaceId(CharSequence value) {
    ...
    /** Sets the value of the 'modelId' field */
    public Builder setModelId(CharSequence value) {
    ...
    /** Sets the value of the 'cpuUtl' field */
    public Builder setCpuUtl(double value) {
    ...
    public WorkspaceEvent build() {
      try {
        ...
        record.workspaceId = fieldSetFlags()[0] ? this.workspaceId : (CharSequence) defaultValue(fields()[0]);
        record.eventTimestamp = fieldSetFlags()[1] ? this.eventTimestamp : (Long) defaultValue(fields()[1]);
        record.modelId = fieldSetFlags()[2] ? this.modelId : (CharSequence) defaultValue(fields()[2]);
        record.state = fieldSetFlags()[3] ? this.state : (CharSequence) defaultValue(fields()[3]);
        record.version = fieldSetFlags()[4] ? this.version : (CharSequence) defaultValue(fields()[4]);
        record.memUtil = fieldSetFlags()[5] ? this.memUtil : (Double) defaultValue(fields()[5]);
        record.cpuUtl = fieldSetFlags()[6] ? this.cpuUtl : (Double) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
